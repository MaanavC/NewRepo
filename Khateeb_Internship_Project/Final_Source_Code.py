...
def welcome_page(agent_info):
    ...
    img = ImageTk.PhotoImage(Image.open("D:\Prithvi_Chetty\Internship\Python_Internship\sunville1.jpg"))
    ...
    img1 = ImageTk.PhotoImage(Image.open("D:\Prithvi_Chetty\Internship\Python_Internship\sunville1.jpg"))
...
def insights():
    ...
    def graph1():
        ...
        def soldvleased(year):
            leased=0
            owned=0
            test = pd.read_excel("D:\Prithvi_Chetty\Internship\Python_Internship\Dataset.xlsx",header=8)
        ...
        maxleasedarea()  
    def graph2():
        excel_file='D:\Prithvi_Chetty\Internship\Python_Internship\Dataset.xlsx'
    ...
    def graph3():
        ...
        print(df)
        #df.to_excel('D:\Prithvi_Chetty\Internship\Python_Internship\\agent code and name.xlsx',index=False)
        df.to_excel('D:\Prithvi_Chetty\Internship\Python_Internship\\agent code and name.xlsx')
        dataset1="D:\Prithvi_Chetty\Internship\Python_Internship\\Dataset.xlsx"
        dataset2="D:\Prithvi_Chetty\Internship\Python_Internship\\agent code and name.xlsx"
        ...
        print(df3)
        df3=df3.to_excel("D:\Prithvi_Chetty\Internship\Python_Internship\Recent Dataset.xlsx")
        df4=pd.read_excel("D:\Prithvi_Chetty\Internship\Python_Internship\Recent Dataset.xlsx")
        property_owned=df4[df4['UoM']=='SQ-M']
        property_owned=property_owned[property_owned['Tenure']=='Owned']
        print(property_owned)
        property_owned_id=property_owned.to_excel("D:\Prithvi_Chetty\Internship\Python_Internship\propertyownedidsqm.xlsx")
        new_excel_owned=pd.read_excel("D:\Prithvi_Chetty\Internship\Python_Internship\propertyownedidsqm.xlsx")
    ...
    def graph4():
        df1=pd.read_excel("D:\Prithvi_Chetty\Internship\Python_Internship\Recent Dataset.xlsx")
        ...
        new_excel=cityleased.to_excel("Chilliwack city leased.xlsx")
        df2=pd.read_excel("Chilliwack city leased.xlsx")
        x=df2['Agent']
        y=df2['Area']
        fig, ax = plt.subplots(figsize =(10, 10))
    ...
    def graph7():
        ...
        #df.to_excel('D:\Prithvi_Chetty\Internship\Python_Internship\Received.xlsx',index=False)
        #df1=pd.read_excel('D:\Prithvi_Chetty\Internship\Python_Internship\Order Received.xlsx',index=False)
        df.to_excel('D:\Prithvi_Chetty\Internship\Python_Internship\Received.xlsx')
        df1=pd.read_excel('D:\Prithvi_Chetty\Internship\Python_Internship\Order Received.xlsx')
        print(df.head())
        x=df1[['ORD_DATE']]
        y=df1[['ORD_AMOUNT']]
